    ...
    <div id="main-wrapper">
        ...
        <div class="featured_slick_gallery gray">
            <div class="featured_slick_gallery-slide">
                <div class="featured_slick_padd"><a href="{{ asset('assets/newFile1/img/0mg27.webp') }}"
                    class="mfp-gallery"><img src="{{ asset('assets/newFile1/img/0mg27.webp') }}"
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12">
                        ...
                        <div class="property_block_wrap style-2 p-4">
                            <div class="prt-detail-title-desc">
                                ...
                                <h3 style="margin-bottom: 10px">83 Vale Street
                                    Elgin, IL 60120</h3>
                                <span style="margin-bottom: 10px"><i class="lni-map-marker"></i> 83 Vale Street
                                    Elgin, IL 60120</span>
                                <h3 class="prt-price-fix" style="margin-top: 10px">$60,600/month</h3>
